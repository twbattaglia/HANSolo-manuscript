...
## Find dropped out oligos (MANSC1 vs. SNORD73)
...
cd4.mansc1.snord73.mean %>% 
  ...
  geom_point(colour = alpha("grey", 0.7)) +
  geom_point(size = 3, colour = "red", data = filter(cd4.mansc1.snord73.mean, Id %in% c("oligo_1895", "oligo_4277"))) + #MANSC1mut
  geom_point(size = 3, colour = "blue", data = filter(cd4.mansc1.snord73.mean, Id %in% c("oligo_1896", "oligo_4278"))) + #MANSC1wt
  geom_point(size = 3, colour = "green", data = filter(cd4.mansc1.snord73.mean, Id %in% c("oligo_1889", "oligo_4271"))) + #RPS3Amut
  geom_point(size = 3, colour = "orange", data = filter(cd4.mansc1.snord73.mean, Id %in% c("oligo_1890", "oligo_4272"))) + #RPS3Awt
  theme_light(base_size = 11) +
